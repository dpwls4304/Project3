...
<script>
	...
	//a태그는 form태그의 하위태그가 아니기 때문에 this.form을 넘길 수 없다.
	function checkAgree() {
		var frm = document.forms.chkFrm;
		if(!(frm.agreement1.checked)){
			document.getElementById("warnAgree").innerHTML = 
				"<b>이용약관과 개인정보취급방침에 모두 동의해주세요.</b>";
			return false;
		}
...
<div id="wrap">
	...
	<div class="contents_box">
		...
		<div class="right_contents">
			...
			<form name="chkFrm" style="text-align: center;">
				<!-- 미동의 경고 -->
				<span id="warnAgree" style="color: red;"></span>
				<!-- 약관동의 -->
				<p style="text-align:center; margin-bottom:20px;">
					<input type="checkbox" name="agreement1" onchange="checking(this);" />이용약관과 개인정보취급방침에 동의합니다.
				</p>
				<p style="text-align:center; margin-bottom:20px;">
					<!-- 확인 -->
					<a href="javascript:void(0)" onclick="checkAgree();"><img src="../images/btn01.gif" /></a>
					&nbsp;&nbsp;
					<!-- 취소를 누르면 main으로 이동 -->
